...
function initializeClient(
	...
	// Fetch a window of messages around a selected message (for jumping
	// to a search result, mention, or notification), page newer history
	// while viewing it, or return to the live end.
