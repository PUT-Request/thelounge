...
- Command palette (`Ctrl`/`Cmd`+`K`): fuzzy-finder over channels, chat commands, and navigation (settings pages, connect, mentions, help, changelog). Picking a channel jumps to it; picking a command drops it into the active input; picking a destination navigates there.
...
- Dependency upgrades: socket.io server and client to 4.8.x (with per-message deflate for large payloads), commander 14, cheerio 1.1, semver 7.7, ua-parser-js 2, bcryptjs 3, mime-types 3, linkify-it 6 (custom schemes ported to the new extension API; protocol-relative URLs now linkify correctly), chalk 6 (via local types, CJS require works), read 6 (promise-based prompt flow), ldapts 9 for LDAP auth (ldapjs kept for the test server), @fastify/busboy 3, lodash 4.18.1 and node-forge 1.4.0 (security), postcss 8.5.23 (security), @types/ws 8.18.1, @types/lodash 4.17.25, @textcomplete 0.1.13, compression (new, for static assets).
- Second wave: Vue 3.5, vue-router 5, Vite 8.2, Vitest 5, Prettier 3, ESLint 9 (flat `eslint.config.mjs`, same rule sets), stylelint 17, commander 15, cheerio 1.2, semver 7.8, mime-types 3.0.2, TypeScript 6.0.3, eslint-config-prettier 10, file-type 21 (security, via dynamic import), dayjs 1.11, emoji-regex 10.6, sortablejs 1.15.7, tsx 4.23, jsdom 30, sinon 22, cross-env 10, npm-run-all2 9, @types/node 26, @types/mime-types 3, @types/semver 7.8, @vitejs/plugin-vue 6.0.8, @vue/test-utils 2.5, @typescript-eslint 8, and pinned transitive security resolutions (browserslist, nanoid, ws, socket.io-parser, ip-address, postcss). Audit warnings down from 87 to 22, all remaining ones dev-only with no same-major patch.
- Removed stale `@types/cheerio` and `@types/bcryptjs` (both libraries bundle their own types now).
- Lint-driven fixes from the engine upgrade: string throws became Errors, bare promise rejections carry reasons, lazy `require()` suppressions renamed, dead `tests/` override glob fixed, and a real `await Promise.all(strings)` wart removed.
...
- Deliberately not upgraded, with reasons: filenamify 7 renames on-disk log folders; package-json 10 restructures version metadata (needs install-flow rework plus registry-backed tests); got stays because link prefetch depends on its streaming abort and local-address bind semantics (v16 would rewrite the fetch layer); ldapjs stays for the LDAP test server while ldapts serves production auth; web-push-neo is kept (it is newer than web-push); irc-framework stays pinned (the ping-timer fix is already in the pinned commit; the residual reconnect-counter quirk is narrow and not worth a local patch without Yarn Berry's patch protocol); vue-router 5, cssnano/postcss majors, and Prettier 3 / ESLint 9 are deferred as high-churn, zero-user-value migrations (cssnano/postcss carry visual-regression risk with no visual test coverage). TypeScript 7 was attempted and reverted: it removes `node10` module resolution (forcing `.js` extensions repo-wide plus dynamic imports for the now ESM-only commander) and needs a parser supporting TS 7 (`@typescript-eslint` 8 caps at `<6.1.0`), which drags in the ESLint 9 flat-config migration.
...
This is a pre-release for v4.6.0 to offer latest changes without having to wait for a stable release.
...
This is a release candidate (RC) for v4.5.1 to ensure maximum stability for public release.
Bugs may be fixed, but no further features will be added until the next stable version.
...
## v4.5.1-pre.1 - 2026-06-14 [Pre-release]

[See the full changelog](https://github.com/thelounge/thelounge/compare/v4.5.0...v4.5.1-pre.1)

This is a pre-release for v4.5.1 to offer latest changes without having to wait for a stable release.
At this stage, features may still be added or modified until the first release candidate for this version gets released.
...
For more details, [see the full changelog](https://github.com/thelounge/thelounge/compare/v4.4.3...v4.5.0) and [milestone](https://github.com/thelounge/thelounge/milestone/45?closed=1).
...
- Style chghost messages ([`fc13502`](https://github.com/thelounge/thelounge/commit/fc135023a42a52c72c471b3910c416c236a29be2) by [@brunnre8](https://github.com/brunnre8))
...
- Update production dependencies to their latest versions:
  ...
  - `cheerio` to 1.0.0 ([`6b30b07`](https://github.com/thelounge/thelounge/commit/6b30b07fc501d170f7dfc66de8703ef943522a00) by [@renovate[bot]](https://github.com/renovate%5Bbot%5D))
  - `node-forge` to 1.3.1 ([`374c6a9`](https://github.com/thelounge/thelounge/commit/374c6a9b04ed67e0a35e970f7bc4517e042d9baf) by [@renovate[bot]](https://github.com/renovate%5Bbot%5D))
  - `express` to 4.20.0 (security) ([`05a8713`](https://github.com/thelounge/thelounge/commit/05a87130ee47275c0c11d5fd4fd333141d812d7a) by [@renovate[bot]](https://github.com/renovate%5Bbot%5D))
  - `mime-types` to 2.1.35 ([`2238808`](https://github.com/thelounge/thelounge/commit/22388087dfb13630b82220b9b8658483b2c8fbe1) by [@renovate[bot]](https://github.com/renovate%5Bbot%5D))
  - `ldapjs` to 2.3.3 ([`381ddca`](https://github.com/thelounge/thelounge/commit/381ddca3583c97c05f26a3180dddf422c33ae6be) by [@renovate[bot]](https://github.com/renovate%5Bbot%5D))
  - `ua-parser-js` to 1.0.39 ([`61f8ce1`](https://github.com/thelounge/thelounge/commit/61f8ce1ae6bcf9ed5cff847157c0d0011b59ef7f) by [@renovate[bot]](https://github.com/renovate%5Bbot%5D))
  - `got` to 11.8.6 ([`1ccce14`](https://github.com/thelounge/thelounge/commit/1ccce14d01ae80e94aac135ee3bb2d1030ab9b1e) by [@renovate[bot]](https://github.com/renovate%5Bbot%5D))
  - `sortablejs` to 1.15.2 ([`f3bdec0`](https://github.com/thelounge/thelounge/commit/f3bdec007823bccfb7414ed5da60b600459b800a) by [@renovate[bot]](https://github.com/renovate%5Bbot%5D))
  - `@textcomplete/textarea` downgraded to v0.10 to match `@textcomplete/core` ([#5076](https://github.com/thelounge/thelounge/pull/5076) by [@xPaw](https://github.com/xPaw))
  - Split sort event ([`0067c30`](https://github.com/thelounge/thelounge/commit/0067c3027348ad3a7fd9f1f7e2354531b5340211) by [@brunnre8](https://github.com/brunnre8))
...
- Drop the `uuid` package in favor of `crypto.randomUUID` ([#5081](https://github.com/thelounge/thelounge/pull/5081) by [@MaxLeiter](https://github.com/MaxLeiter))
...
- Remove DNS resolution order override ([`a61bc14`](https://github.com/thelounge/thelounge/commit/a61bc14456dcaf335884e62cabb1368df5db9b41) by [@brunnre8](https://github.com/brunnre8))
...
- Fix call stack size exceeded ([#5023](https://github.com/thelounge/thelounge/pull/5023) by [@marmitar](https://github.com/marmitar))
- Fix mobile viewport ([#5029](https://github.com/thelounge/thelounge/pull/5029) by [@Jay2k1](https://github.com/Jay2k1))
...
- Suppress "\*\*\*" in joins/parts/etc. for screen readers ([`59e8b16`](https://github.com/thelounge/thelounge/commit/59e8b16990787eed99c7307456e934fb4277ea8d) by [@kfranqueiro](https://github.com/kfranqueiro))
- Indicate active context menu item for screen readers ([`4ba1636`](https://github.com/thelounge/thelounge/commit/4ba16364cc8d3730449ce8d23641787b270220be) by [@kfranqueiro](https://github.com/kfranqueiro))
- Fix showing multiple certificate fingerprints on InspIRCd v4 ([`e44bed1`](https://github.com/thelounge/thelounge/commit/e44bed1758a466b0983eadbaecfdcd7d5ef145ee) by [@sadiepowell](https://github.com/sadiepowell))
- Fix broken manual channel ordering ([`8925629`](https://github.com/thelounge/thelounge/commit/892562902f8a45b0eb1e890281c2a15292fe5235) by [@Jay2k1](https://github.com/Jay2k1))
- Disable SASL if SASL isn't configured ([`b270f51`](https://github.com/thelounge/thelounge/commit/b270f5102281589cb60ee69d28598cf3421b4f82) by [@brunnre8](https://github.com/brunnre8))
- Reverse locknetwork config selection ([`3f2697c`](https://github.com/thelounge/thelounge/commit/3f2697cca6916fba28ccf93c650177fea9cfd443) by [@brunnre8](https://github.com/brunnre8))
- server: fix scoped package install ([`0a4adc4`](https://github.com/thelounge/thelounge/commit/0a4adc4592ac1ada9ba97c66c8034baf420ae591) by [@arminius-smh](https://github.com/arminius-smh))
- server: fix loading themes from scoped packages ([`ac485c4`](https://github.com/thelounge/thelounge/commit/ac485c483b446b5ebaf1a7b0d5f6373f1585cdd1) by [@arminius-smh](https://github.com/arminius-smh))
- server: fix time handling ([`0d9c184`](https://github.com/thelounge/thelounge/commit/0d9c184f19dd26fc9bc7e7c8b112e02c5261fe71) by [@brunnre8](https://github.com/brunnre8))
- server: Fix quoting in error message ([`be603c6`](https://github.com/thelounge/thelounge/commit/be603c6bdcde7efb41164959fcbd97df3478f4a0) by [@supertassu](https://github.com/supertassu))
- Identd: fix various issues (write after connection end, ip/port tuple matching, idle connection close) ([`0955d9d`](https://github.com/thelounge/thelounge/commit/0955d9df06e9526da4ad2e5e36e8451e4dca7270) by [@brunnre8](https://github.com/brunnre8))
- fix /mute not persisting, case-insensitive channel check ([`#`](https://github.com/thelounge/thelounge/pull/5083) by [@MaxLeiter](https://github.com/MaxLeiter))
...
- Escape user-supplied LDAP filter value as per RFC 4515 ([#5084](https://github.com/thelounge/thelounge/pull/5084) by [@MaxLeiter](https://github.com/MaxLeiter))
- Update `socket.io` to 4.6.2 (security) ([`a900943`](https://github.com/thelounge/thelounge/commit/a90094334567c879f8cb58da898f35fe57662626) by [@renovate[bot]](https://github.com/renovate%5Bbot%5D))
- Update `webpack` to 5.94.0 (security) ([`8ed8988`](https://github.com/thelounge/thelounge/commit/8ed898846c85ef43e166ad903c1676381389897c) by [@renovate[bot]](https://github.com/renovate%5Bbot%5D))
- Update `express` to 4.20.0 (security) ([`05a8713`](https://github.com/thelounge/thelounge/commit/05a87130ee47275c0c11d5fd4fd333141d812d7a) by [@renovate[bot]](https://github.com/renovate%5Bbot%5D))
- Bump braces from 3.0.2 to 3.0.3 ([`e812731`](https://github.com/thelounge/thelounge/commit/e81273148b4390ab8a8570d2296fa7e3569610aa) by [@dependabot[bot]](https://github.com/dependabot%5Bbot%5D))

### Documentation

- Update build status badge URL in README.md ([`223e30e`](https://github.com/thelounge/thelounge/commit/223e30e51fa17dba8f4426c1a08495f635a7176d) by [@xPaw](https://github.com/xPaw))

On the [website repository](https://github.com/thelounge/thelounge.github.io):

- update config include ([`fe3e08d`](https://github.com/thelounge/thelounge.github.io/commit/fe3e08d15a8ae8b2c69ad1f1d1c86b86d095c664) by [@brunnre8](https://github.com/brunnre8))
- docker: use named volume mounts ([`2ecee6b`](https://github.com/thelounge/thelounge.github.io/commit/2ecee6bb58ecb44df64b2858032893c7e91efe4c) by [@brunnre8](https://github.com/brunnre8))
- Remove inline style ([`2cef626`](https://github.com/thelounge/thelounge.github.io/commit/2cef626893ab4ada49d74f01258786cd62a3c326) by [@xPaw](https://github.com/xPaw))
- Add CSP header ([`ce6210e`](https://github.com/thelounge/thelounge.github.io/commit/ce6210e60dce903bbfa0eeefbe2fe4f60e7087c0) by [@xPaw](https://github.com/xPaw))
- Add italics image to repo ([`ae1a9ba`](https://github.com/thelounge/thelounge.github.io/commit/ae1a9baa78186dc478bc0784976cd256bd03fb8e) by [@xPaw](https://github.com/xPaw))
- Fix csp for community page ([`4ccb3ce`](https://github.com/thelounge/thelounge.github.io/commit/4ccb3ce6eb91360aec7b7d1b0dfa700d91551709) by [@xPaw](https://github.com/xPaw))
- Update icons ([`9ef2ca4`](https://github.com/thelounge/thelounge.github.io/commit/9ef2ca46eaa7aec4ec4980cc5dac4f26107b5dac) by [@xPaw](https://github.com/xPaw))
- Remove the reference that iOS does not support push ([#281](https://github.com/thelounge/thelounge.github.io/pull/281) by [@AN1MATEK](https://github.com/AN1MATEK))
- Adding CSS snippet to hide unread badge for muted channels ([#274](https://github.com/thelounge/thelounge.github.io/pull/274) by [@ben-bartholomew](https://github.com/ben-bartholomew))
- Add opencollective to frame-src ([`d9cad01`](https://github.com/thelounge/thelounge.github.io/commit/d9cad01b62a443ceb9ca5f3e17d01564c3ee3f03) by [@xPaw](https://github.com/xPaw))
- Add font preloads ([`178d909`](https://github.com/thelounge/thelounge.github.io/commit/178d90994cd2490b8be338cc1f19e8346cc16f4e) by [@xPaw](https://github.com/xPaw))
- Add aspect ratio to the screenshot ([`3926d26`](https://github.com/thelounge/thelounge.github.io/commit/3926d26e10afd4a86465d409ed4021e44378e060) by [@xPaw](https://github.com/xPaw))
- Inline the logo svg ([`01dba40`](https://github.com/thelounge/thelounge.github.io/commit/01dba40cbaa6fcb860bf77392d9531e91ff37e92) by [@xPaw](https://github.com/xPaw))
- Add font-display: swap ([`531edf1`](https://github.com/thelounge/thelounge.github.io/commit/531edf1d0bcb04ef1e1f5d735480b845fa321c11) by [@xPaw](https://github.com/xPaw))
- Fix color contrast ([`d3f8388`](https://github.com/thelounge/thelounge.github.io/commit/d3f8388e7c43c1db548018d898183077d1333e03) by [@xPaw](https://github.com/xPaw))
- Remove jquery ([`8dfdda8`](https://github.com/thelounge/thelounge.github.io/commit/8dfdda8c226d1b769f07354b702b6594b167309e) by [@xPaw](https://github.com/xPaw))
- Fix event ([`e79714e`](https://github.com/thelounge/thelounge.github.io/commit/e79714eea4a394c5d64885f39a2566ea5e43234a) by [@xPaw](https://github.com/xPaw))
- Make anchors unfocusable ([`cb0527f`](https://github.com/thelounge/thelounge.github.io/commit/cb0527ff6f762412ca4f063ac923bf9d77ad3bd4) by [@xPaw](https://github.com/xPaw))
- Add scrollbar-gutter: stable ([`e0144dd`](https://github.com/thelounge/thelounge.github.io/commit/e0144ddebfe8efc2c15c19d61c7405146a429b68) by [@xPaw](https://github.com/xPaw))
- Add missing plugins link to mobile menu ([`f90c640`](https://github.com/thelounge/thelounge.github.io/commit/f90c640ac912760bd1e03022d5032f9862a6bc99) by [@xPaw](https://github.com/xPaw))
- Fix deprecated links to Yarn Classic in install-and-upgrade (#284) ([`4fb3e0c`](https://github.com/thelounge/thelounge.github.io/commit/4fb3e0c4891d53489fac62278da0687cf6511966) by [@feeRnt](https://github.com/feeRnt))
- Update cloudflare docs ([`e510deb`](https://github.com/thelounge/thelounge.github.io/commit/e510debefd6103b304427b327ffa88e2f56991e7) by [@xPaw](https://github.com/xPaw))
- Remove caddy v1 ([`d2e3190`](https://github.com/thelounge/thelounge.github.io/commit/d2e319044098cac0bf0746e261867771484623a9) by [@xPaw](https://github.com/xPaw))
- Fix typos ([`3d2884e`](https://github.com/thelounge/thelounge.github.io/commit/3d2884efabb2bbb72cef10f154671980e6d90abe) by [@xPaw](https://github.com/xPaw))
- Remove dead community links ([`db00824`](https://github.com/thelounge/thelounge.github.io/commit/db0082422a79f7e0171a2b58834e251fa57c73d7) by [@xPaw](https://github.com/xPaw))
- Improve page descriptions ([`a15666e`](https://github.com/thelounge/thelounge.github.io/commit/a15666e6c982764197f4c8710b793de05fb907bf) by [@xPaw](https://github.com/xPaw))
- Add irc page ([`55c811f`](https://github.com/thelounge/thelounge.github.io/commit/55c811f7274a0a6aa1aa1ac259deed34ba7feb06) by [@xPaw](https://github.com/xPaw))
- Update jekyll ([`086cb35`](https://github.com/thelounge/thelounge.github.io/commit/086cb353f6f26780ecd2fc42126c257de0677ae0) by [@xPaw](https://github.com/xPaw))

### Internals

- Untangle client and server: extract shared types, move chan/network/user models to `shared/`, type the socket layer ([`f792626`](https://github.com/thelounge/thelounge/commit/f7926267d97cb8757aa191a23192e06d1a6a2276) and many follow-ups by [@brunnre8](https://github.com/brunnre8))
- Remove all server files from client compilation ([`e43cbb1`](https://github.com/thelounge/thelounge/commit/e43cbb139c547032a1cd194d443b807fbce66398) by [@brunnre8](https://github.com/brunnre8))
- TypeScript update + remove unused `.d.ts` file ([#4869](https://github.com/thelounge/thelounge/pull/4869), [#4870](https://github.com/thelounge/thelounge/pull/4870) by [@brunnre8](https://github.com/brunnre8))
- Refactor Mentions, add `isIgnoredUser` util ([#5051](https://github.com/thelounge/thelounge/pull/5051) by [@MaxLeiter](https://github.com/MaxLeiter))
- tests/coverage: ignore `test/client` and `test/public`, fix running coverage ([#5085](https://github.com/thelounge/thelounge/pull/5085) by [@MaxLeiter](https://github.com/MaxLeiter))
- changelog: don't type assert to a broken type, fix data type ([`4d23760`](https://github.com/thelounge/thelounge/commit/4d237600d5ee2c1639f275a66e7307337e93b93b), [`7bc184b`](https://github.com/thelounge/thelounge/commit/7bc184b252d790b4a78db1cf0e05d8efd22b4bb6) by [@brunnre8](https://github.com/brunnre8))
- changelog: fix handling now non-existent optionalDependencies ([#5078](https://github.com/thelounge/thelounge/pull/5078) by [@MaxLeiter](https://github.com/MaxLeiter))
- Fix `generate-config-doc.js` ([#4856](https://github.com/thelounge/thelounge/pull/4856) by [@brunnre8](https://github.com/brunnre8))
- Add `.node-version` file ([#5069](https://github.com/thelounge/thelounge/pull/5069), [#5074](https://github.com/thelounge/thelounge/pull/5074) by [@MaxLeiter](https://github.com/MaxLeiter))
- workflows: don't run on push and PR for every branch ([#5066](https://github.com/thelounge/thelounge/pull/5066) by [@MaxLeiter](https://github.com/MaxLeiter))
- release workflow: switch to tokenless, allow `workflow_dispatch`, pin to Node 22 ([#5080](https://github.com/thelounge/thelounge/pull/5080), [`6ef22b2`](https://github.com/thelounge/thelounge/commit/6ef22b2b89524c2c51bcce975e28456dc431f261), [`a113bb3`](https://github.com/thelounge/thelounge/commit/a113bb3f09b350c5c632b985594bf2d75c560a69) by [@MaxLeiter](https://github.com/MaxLeiter))
- `package.json`: run `npm pkg fix` ([#5079](https://github.com/thelounge/thelounge/pull/5079) by [@MaxLeiter](https://github.com/MaxLeiter))
- fix generate-config-doc.js ([#4856](https://github.com/thelounge/thelounge/pull/4856) by [@brunnre8](https://github.com/brunnre8))
- chore: replace uuid package with crypto.randomUUID (#5081) ([`5b83f0a`](https://github.com/thelounge/thelounge/commit/5b83f0ab4e796012fa376da520442481df611b38) by [@MaxLeiter](https://github.com/MaxLeiter))
- tests/coverage: ignore test/client and test/public, fix running cover… ([`05382b2`](https://github.com/thelounge/thelounge/commit/05382b2acc9bdc0b1c99a71a340b9257e8c20d9c) by [@MaxLeiter](https://github.com/MaxLeiter))
- Update browserslist / caniuse data ([#5075](https://github.com/thelounge/thelounge/pull/5075) by [@MaxLeiter](https://github.com/MaxLeiter))
- Update development dependencies to their latest versions:
  - `@types/ws` to 8.5.12 ([`f892884`](https://github.com/thelounge/thelounge/commit/f89288414affdda8492d22d272c0e3e9682dc0c2) by [@renovate[bot]](https://github.com/renovate%5Bbot%5D))
  - `@vue/test-utils` to 2.4.6 ([`9e6eef3`](https://github.com/thelounge/thelounge/commit/9e6eef302017f3cb4ad38987060256f9ceeb4d50) by [@renovate[bot]](https://github.com/renovate%5Bbot%5D))
  - `postcss` to 8.4.47 ([`a6af6bb`](https://github.com/thelounge/thelounge/commit/a6af6bb45c5f83dc0ae7dd6f48c4980f1ac6ad5e) by [@renovate[bot]](https://github.com/renovate%5Bbot%5D))
  - `vue-eslint-parser` to 9.4.3 ([`a051a70`](https://github.com/thelounge/thelounge/commit/a051a70b02caeafd8c229563c5734618ec65f359) by [@renovate[bot]](https://github.com/renovate%5Bbot%5D))
...
- Fix mobile viewport ([#5029](https://github.com/thelounge/thelounge/pull/5029) by [@Jay2k1](https://github.com/Jay2k1))
- Fix order of messages with identical timestamps ([#5087](https://github.com/thelounge/thelounge/pull/5087) by [@Jay2k1](https://github.com/Jay2k1))
- Fix `/mute` not persisting, case-insensitive channel check ([#5083](https://github.com/thelounge/thelounge/pull/5083) by [@MaxLeiter](https://github.com/MaxLeiter))
- Fix inverted boolean check with expand & collapse ([#5082](https://github.com/thelounge/thelounge/pull/5082) by [@MaxLeiter](https://github.com/MaxLeiter))
- Fix PWA installation behind Cloudflare Access ([#5032](https://github.com/thelounge/thelounge/pull/5032) by [@MaxLeiter](https://github.com/MaxLeiter))
- Fix `.DS_Store` crash by using `fs.rmSync` in storage cleanup ([`c88f647`](https://github.com/thelounge/thelounge/commit/c88f647f1ae61b7470c20db89b83f0dfdf45da73) by [@MaxLeiter](https://github.com/MaxLeiter))
...
- update default config to include `storagePolicy` ([`fe3e08d`](https://github.com/thelounge/thelounge.github.io/commit/fe3e08d15a8ae8b2c69ad1f1d1c86b86d095c664) by [@brunnre8](https://github.com/brunnre8))
- docker: use named volume mounts ([`2ecee6b`](https://github.com/thelounge/thelounge.github.io/commit/2ecee6bb58ecb44df64b2858032893c7e91efe4c) by [@brunnre8](https://github.com/brunnre8))
- Remove inline style ([`2cef626`](https://github.com/thelounge/thelounge.github.io/commit/2cef626893ab4ada49d74f01258786cd62a3c326) by [@xPaw](https://github.com/xPaw))
- Add CSP header ([`ce6210e`](https://github.com/thelounge/thelounge.github.io/commit/ce6210e60dce903bbfa0eeefbe2fe4f60e7087c0) by [@xPaw](https://github.com/xPaw))
- Add italics image to repo ([`ae1a9ba`](https://github.com/thelounge/thelounge.github.io/commit/ae1a9baa78186dc478bc0784976cd256bd03fb8e) by [@xPaw](https://github.com/xPaw))
...
[See the full changelog](https://github.com/thelounge/thelounge/compare/v4.5.0-pre.1...v4.5.0-rc.1)
...
[See the full changelog](https://github.com/thelounge/thelounge/compare/v4.4.3...v4.5.0-pre.1)
