...
- Second wave: Vue 3.5, Vite 8.2, Vitest 5, vue-router 4.6, commander 15, cheerio 1.2, semver 7.8, mime-types 3.0.2, TypeScript 6.0.3, eslint-config-prettier 10, file-type 21 (security, via dynamic import), dayjs 1.11, emoji-regex 10.6, sortablejs 1.15.7, tsx 4.23, jsdom 30, sinon 22, cross-env 10, npm-run-all2 9, @types/node 26, @types/mime-types 3, @types/semver 7.8, @vitejs/plugin-vue 6.0.8, @vue/test-utils 2.5, @typescript-eslint 8 (staying on ESLint 8 config), and pinned transitive security resolutions (browserslist, nanoid, ws, socket.io-parser, ip-address, postcss). Audit warnings down from 87 to 22, all remaining ones dev-only with no same-major patch.
